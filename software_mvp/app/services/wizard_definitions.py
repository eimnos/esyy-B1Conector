    ...
    "schedule": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "title": "Frequenza",
                "type": "choice",
                "question": "Quale frequenza base preferisci?",
                "description": "Selezione rapida prima della definizione cron tecnica.",
                "options": [
            ...
            },
            {
                ...
                "title": "Timezone",
                "type": "input",
                "question": "Timezone da usare per il cron?",
                "description": "Esempio Europe/Rome.",
                "fields": [
                    {"id": "timezone", "label": "Timezone", "placeholder": "Europe/Rome"},
                ],
            },
            {
                "id": "review",
                "title": "Conferma",
                "type": "review",
                "question": "Confermi la pianificazione?",
                "description": "Applica poi il cron nella pagina Schedules.",
            },
        ],
    },
    "access": {
